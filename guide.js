...
const GUIDE_INTRO_EN = 'Pizza Planner works <b>backwards</b>: you say when the pizza should be ready, and the app shows exactly when and how you need to work to hit that. This user manual walks through the entire mobile app — tap a topic in the list below to jump straight there.';
...
const GUIDE_EN = [
...

  {
    ...
    body: [
      {t:'p', x:'You can install Pizza Planner as an app icon on your phone, and use it offline. A little line <b>"📲 Add the app to your home screen"</b> appears when it\'s possible.'},
      {t:'bullets', x:[
